...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        {
            // NOTE: MOCKING AUTHORIZE(AUTHENTICATION)
    ...
    public async Task CreateAuction_WithValidCreateAuctionDto_ReturnsCreatedAtAction()
    {
        ...
        // _mapper.Map<AuctionCreated>(auction)

        // _publishEndpoint.Verify(svcBus =>
        //     svcBus.Publish<AuctionCreated>(
        //         It.IsAny<AuctionCreated>(),
